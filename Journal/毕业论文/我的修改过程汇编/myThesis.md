...
密码在文中的位置|密码缩写|名称|含义
---|---|---|---|---|---|---
前言|WTD|他们**要**做什么<br>**W**hat **T**hey **D**o|作者（们）**声称要**在论文/书中做什么；<br>这一密码提炼出了作者在文本中提出的主要问题。<br>**主要观点、研究材料、研究方法**
...
权利范围：|全部
权利取得方式：|原始取得
开发的硬件环境：|CPU主频>1G，内存>2GB，硬盘空间>50GB
